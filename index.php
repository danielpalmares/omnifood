...
<head>
    ...
    <!-- Vai dizer aos celulares, por exemplo, que não devem diminuir o zoom da página e que devem sempre começar com o scale 1 -->
...
<body>
        ...
        <nav>
            <div class="row">
                ...
                <ul class="main-nav js--main-nav">
                    <li><a href="#features">Food delivey</a></li>
    ...
    <section class="section-features js--section-features" id="features">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-4 box">
                <ion-icon name="restaurant-outline" class="big-icon"></ion-icon>
                <h3>100% organic</h3>
    ...
    <section class="section-meals">
        <ul class="meals-showcase clearfix">
            <!-- clearfix aqui porque os elementos filhos desta classe que são as li, são aqueles que possui a propriedade float -->
            <li>
        ...
        <div class="row cities-content">
            <div class="col span-1-of-4 box">
                ...
                <div class="cities-info">
                    ...
                    <div class="city-feature">
                        <ion-icon name="star" class="small-icon"></ion-icon>
                        60+ top chefs
                    </div>
                    <div class="city-feature">
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>1 meal every day
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>Order 24/7
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>Access to newest
                                creations
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>Free delivery
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>1 meal 10 days/month
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>Order 24/7
                            </li>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>1 meal
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" class="small-icon"></ion-icon>Order from 8 am to 12
                                pm
                            </li>
                            <li>
